...
sleep 2
nohup uvicorn backend.main:app --host 0.0.0.0 --port 8001 > ~/aula-dashboard/server.log 2>&1 &
BOOT
...
sleep 1
nohup uvicorn backend.main:app --host 0.0.0.0 --port 8001 > "$INSTALL_DIR/server.log" 2>&1 &
sleep 3
...
if pgrep -f uvicorn > /dev/null; then
    ...
    printf "  Dashboard:     http://familiekalender.local:8001\n"
    printf "  Indstillinger: http://familiekalender.local:8001/settings.html\n"
    printf "==================================================\n"
else
